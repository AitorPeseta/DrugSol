...
class _listSt6vectorIjSaIjEE(Boost.Python.instance):
    ...
    def __iter__(self) -> typing.Any:
        """
            C++ signature :
                boost::python::objects::iterator_range<boost::python::return_internal_reference<1ul, boost::python::default_call_policies>, std::_List_iterator<std::vector<unsigned int, std::allocator<unsigned int> > > > __iter__(boost::python::back_reference<std::__cxx11::list<std::vector<unsigned int, std::allocator<unsigned int> >, std::allocator<std::vector<unsigned int, std::allocator<unsigned int> > > >&>)
        """
    def __len__(self) -> int:
        """
            C++ signature :
...
class _listi(Boost.Python.instance):
    ...
    def __iter__(self) -> typing.Any:
        """
            C++ signature :
                boost::python::objects::iterator_range<boost::python::return_value_policy<boost::python::return_by_value, boost::python::default_call_policies>, std::_List_iterator<int> > __iter__(boost::python::back_reference<std::__cxx11::list<int, std::allocator<int> >&>)
        """
    def __len__(self) -> int:
        """
            C++ signature :
...
boostVersion: str = '1_84'
rdkitBuild: str = 'Linux|6.5.0-1016-azure|UNIX|GNU|64-bit'
rdkitVersion: str = '2023.09.6'
