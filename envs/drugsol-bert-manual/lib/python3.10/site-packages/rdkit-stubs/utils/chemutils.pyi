...
def ConfigToNumElectrons(config, ignoreFullD = 0, ignoreFullF = 0):
    ...
    """
def GetAtomicData(atomDict, descriptorsDesired, dBase = '/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/share/RDKit/Data/atomdb.gdb', table = 'atomic_data', where = '', user = 'sysdba', password = 'masterkey', includeElCounts = 0):
    """
...
def SplitComposition(compStr):
    ...
    """
_atomDbName: str = '/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/share/RDKit/Data/atomdb.gdb'
