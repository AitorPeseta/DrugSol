...
RDCodeDir=os.path.join(r'/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib/python3.10/site-packages','rdkit')
# not really hard-coded alternative RDCodeDir=os.path.dirname(__file__)
_share = os.path.join(r'/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual', r'share/RDKit')
