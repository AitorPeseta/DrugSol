...
# installed.
TCL_PREFIX='/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1769459871528/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib -Wl,-rpath-link,/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib -L/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/include'
...
# compiled.
TCL_SRC_DIR='/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/mnt/c/URV/TFG/DrugSol/envs/drugsol-bert-manual/lib/libtclstub8.6.a'
